...
void countingSort(int *array, int arrayLength, int limit) {
  ...
  for (int i = arrayLength - 1; i >= 0; i--) {
    // for each element in array, check how many element less than or equal to
    // it exist in the array then insert element into result at the last index
    // that it could appear at consistent with the previous result note - we
    // have to shift some of the indices by 1 compared to the book because
    // they've indexed arrays from 1
