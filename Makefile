...
all: insertion_sort merge_sort hybrid_merge_insertion_sort bubble_sort test
...
test: src/test.c
	${CC} ${CFLAGS} src/test.c obj/insertion_sort.o obj/merge_sort.o obj/hybrid_merge_insertion_sort.o obj/bubble_sort.o -o bin/test
